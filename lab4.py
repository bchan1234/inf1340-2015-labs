...
def calc_provincial_tax(purchase):
    return purchase * PROVINCIAL_TAX


def calc_federal_tax(purchase):
    return purchase * FEDERAL_TAX


def bill_of_sale(purchase):
    prov_tax = calc_provincial_tax(purchase)
    fed_tax = calc_federal_tax(purchase)

    file_name = "billofsales.txt"
